...
import com.pso.bigquery.optimization.exceptions.CatalogFailure;
import com.pso.bigquery.optimization.exceptions.ParsedStatementFailure;
...
public class QueryAnalyzer {
  ...
  public Try<Void> updateCatalogFromSQL(String projectId, String query, SimpleCatalog catalog) {
  ...
  public void visitQuery(
    ...
    if (catalogScope.equals(CatalogScope.QUERY)) {
      ...
      Try<Void> tryUpdateCatalog = this.updateCatalogFromSQL(billingProjectId, query, catalog);
      if (tryUpdateCatalog.isFailure()) {
